...
結果は、より精緻なデータベースが、時間的対応指標（IDF1、AssA、HOTA、MOTA、MT%、IDSW、Frag）の向上を通じて追跡タスクの性能を高め、セグメンテーション品質を改善し得ること、ハイパーパラメータ最適化がより良い成果をもたらすこと、そしてTensorRTへの変換が最小限の性能低下で推論時間を大幅に短縮することを示しています。
