\section{Metodología}
% TODO Corrección [14]: Al mover definición formal de pruebas y métricas a Capítulo 4 (Validación), aquí mantener solo flujo de alto nivel. Añadir referencia cruzada a nueva sección "Validación" una vez creada.
...
% TODO lenguaje: Evitar repetición de conectores (“Además,”). Considera “Asimismo,” o “En paralelo,”.
% TODO lenguaje: Unificar “base de datos” vs “dataset”; si usas “dataset”, ponerlo en cursiva o entre comillas la primera vez.