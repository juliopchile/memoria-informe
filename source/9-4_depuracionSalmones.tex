...
% TODO Corrección [14]: Parte de esta sección (procedimiento de filtrado, criterios cuantitativos y justificación) debe trasladarse al Capítulo 4 (Validación) como sección de preparación de datasets y pruebas para validar hipótesis (impacto depuración en segmentación y tracking).
