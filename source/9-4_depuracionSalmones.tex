...
A continuación se muestran imagenes de ejemplo de la base de datos Salmons. En rojo se muestran las segmentaciones consideradas ``pequeñas'', en amarillo las ``medianas'' y en verde las ``grandes''. El texto blanco corresponde a el área en pixeles de cada segmentación, normalizada a una imagen de 640x640 pixeles. Dependiendo del criterio de filtrado, las segmentaciones pequeñas y medianas pueden ser eliminadas o reasignadas a otra clase, igualmente se podría con algún criterio de nitidez o forma.

\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/filter1.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/filter2.jpg}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/filter3.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/filter4.jpg}
    \end{subfigure}

    \caption[Ejemplo de uso del código de filtrado de base de datos]{Ejemplo de uso del código de filtrado de base de datos.}
\end{figure}
