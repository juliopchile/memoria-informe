...
La lista completa de métricas soportadas son: \textbf{área}, \textbf{perímetro}, \textbf{relación de aspecto}, \textbf{circularidad}, \textbf{compactación}, \textbf{excentricidad}, \textbf{elongación}, \textbf{rectangularidad} y \textbf{nitidez}. Se normalizan las métricas asumiendo una imagen de 640x640 píxeles. El código también permite filtrar las etiquetas por clase, lo que resulta útil para depurar bases de datos con múltiples clases.
% TODO lenguaje: “píxeles” con tilde; “excentricidad” en español usual, revisar “eccentricidad”.

Para la nitidez se utiliza una media logarítmica ponderada entre la nitidez de borde y nitidez interna. La nitidez de borde se obtiene con el promedio de la magnitud del gradiente de Sobel dentro de una banda que rodea el borde de la segmentación, mientras que la nitidez interna se calcula con la varianza del filtro Laplaciano aplicado a los píxeles dentro de la segmentación.
% TODO lenguaje: “del borde de la segmentación”; “píxeles” con tilde.
...
\subsection{Filtrado}
En primera instancia se mejoran a mano las etiquetas dentro de la base de datos de Salmons_2024base, mejorando los contornos, combinando segmentaciones divididas en múltiples instancias o extendiendo polígonos incompletos. Luego se crea una copia local con la cual se crean las distintas variaciones.
% TODO lenguaje: “polígonos”, “distintas” con tilde/corrección.
...
A continuación se muestran algunas imágenes de la base de datos Salmons_2024base y sus etiquetadas, clasificadas por área de segmentación.
...
\begin{center}
    ...
    \end{subfigure}
  \caption[Ejemplo de uso del código de filtrado de base de datos]{Ejemplo de uso del código de filtrado de base de datos. En rojo se muestran las segmentaciones consideradas ``pequeñas'', en amarillo las ``medianas'' y en verde las ``grandes''. El texto blanco corresponde al área en píxeles de cada segmentación, normalizada a una imagen de 640x640 píxeles. Dependiendo del criterio de filtrado, las segmentaciones pequeñas y medianas pueden ser eliminadas o reasignadas a otra clase; igualmente se podría aplicar algún criterio de nitidez o forma.}
  % TODO lenguaje: “al área”, “píxeles” con tilde; mejorar puntuación.
