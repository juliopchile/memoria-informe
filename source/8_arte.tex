...
% TODO Corrección [8]: Corregir redacción "reducción en consumo energéticos" -> "reducción en consumo energético" en el párrafo siguiente.
...
% TODO Corrección [8]: En la subsección 3.5.1 (equivalente tras reordenar) enfatizar explícitamente que dada la utilización de modelos de detección y segmentación de instancia, tracking-by-detection es el enfoque adecuado (agregar párrafo de enlace con objetivos y validación).
