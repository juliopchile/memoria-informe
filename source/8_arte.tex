...
% TODO Corrección [7]: Al final de este capítulo agregar subsección 2.3 Discusión (contrastar solución propuesta vs. soluciones existentes; justificar elección de tracking-by-detection con métricas HOTA, AssA, IDF1, MOTA; destacar contribución de depuración de dataset y exportación eficiente).
