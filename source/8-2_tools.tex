...
En esta sección se discuten los programas y herramientas utilizadas en el desarrollado de esta memoria (bibliotecas, utilidades y bases de datos).
...
Para el etiquetado de imágenes se exploraron varias plataformas para determinar cual se acomoda más a las necesidades del proyecto y WildSense ---dada la colaboración con ellos.
