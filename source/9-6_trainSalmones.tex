...
El análisis es identico al de Deepfish, por lo que solo se resumen los resultados más relevantes.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/Salmons-sizeComparison-YOLO-mAP50-95(M).pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/Salmons-TransferLearningComparison-YOLO-mAP50-95(M).pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/Salmons-OptimizerComparison-YOLO-mAP50-95(M).pdf}
...
A diferencia de Deepfish, en Salmons no se observaron diferencias significativas promedio entre entrenar con imágenes de fondo (Full) o sin ellas (``LO'') (tabla \ref{tab:salmons_mejoraRelativa_model} y fig. \ref{fig:salmons_yolo_dataset_comparison}). En promedio incluir imagenes de fondo empeora el rendimiento en 0.12\% en mAP@50-95. Similar a Deepfish, esta diferencia aumenta al exportar a TensorRT-INT8, decayendo en hasta un 3\% su rendimiento (fig. \ref{fig:salmons_yolo_transfer_learning_factor_mejora_by_format}).
...
Otra alternativa se haya en como está definida la base de datos de validación. Al poseer pocas imagenes sin instancias de peces o con contextos complejos que se beneficien de distinguir salmones de no salmones, el modelo no es capaz de validar correctamente su aprendizaje y pareciera que es peor, cuando en la práctica podría no serlo.
...
\begin{figure}[htb]
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Salmons-DatasetComparison-YOLO-mAP50-95(M).pdf}
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Salmons-DatasetFactorMejora-YOLO-mAP50-95(M).pdf}
...
\begin{figure}[htbp]
\begin{center}
    \includegraphics[width=0.9\textwidth]{figures/Salmons-FormatComparison-YOLO-mAP50-95(M).pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/Salmons-TransferLearningFactorMejora-Format-mAP50-95(M).pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/Salmons-DatasetFactorMejora-Format-mAP50-95(M).pdf}
...
\hline
\multicolumn{1}{|c|}{\textbf{Model}} & \multicolumn{1}{c|}{\textbf{precision(M)}} & \multicolumn{1}{c|}{\textbf{recall(M)}} & \multicolumn{1}{c|}{\textbf{F1\_score(M)}} & \multicolumn{1}{c|}{\textbf{mAP50(M)}} & \multicolumn{1}{c|}{\textbf{mAP50-95(M)}} & \multicolumn{1}{c|}{\textbf{Format}} \\ \hline
...
\multirow{3}{*}{yolov8l-seg} & 0.934967 & 0.906950 & 0.920745 & 0.964219 & 0.855048 & Pytorch \\ \cline{2-7} 
...
\multirow{3}{*}{yolo11m-seg} & 0.948910 & 0.878505 & 0.912351 & 0.958191 & 0.836368 & Pytorch \\ \cline{2-7} 
...
\multirow{3}{*}{yolo11l-seg} & 0.907006 & 0.918224 & 0.912581 & 0.960751 & 0.854808 & Pytorch \\ \cline{2-7} 
...
Los resultados obtenidos con Salmons son satisfactorios al demostrar que depurar la base de datos y aumentar su tamaño permite entrenar modelos más precisos en la detección y segmentación de instancias de interes. Sin embargo, hay un aspecto que merecen ser discutidos y es que al ser una base de datos donde no todas las instancias de salmones están etiquetadas, el modelo puede aprender a ignorar ciertas instancias que en la práctica deberían ser detectadas y viceversa. Esto significa que el \textit{dataset} en si no está bien definido y cualquier análisis cuantitativo de sus resultados debe ser tomado con pinzas pues esto no refleja su verdadero rendimiento.
...
\begin{center}
    ...
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/original/Seguimiento_1_000219.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/painted/Seguimiento_1_000219.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/predict/Seguimiento_1_000219.jpg}
    \end{subfigure}
    % ====== Ejemplo 2 ======
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/original/Seguimiento_2_000033.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/painted/Seguimiento_2_000033.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/predict/Seguimiento_2_000033.jpg}
    \end{subfigure}
    % ====== Ejemplo 3 ======
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/original/741_png_jpg.rf.836cc3dba57ee593e9b4b5a1a61f099d.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/painted/741_png_jpg.rf.836cc3dba57ee593e9b4b5a1a61f099d.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/predict/741_png_jpg.rf.836cc3dba57ee593e9b4b5a1a61f099d.jpg}
    \end{subfigure}
    % ====== Ejemplo 4 ======
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/original/Img3_jpeg.rf.3a846528a9da542cae08a04d32cb2468.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/painted/Img3_jpeg.rf.3a846528a9da542cae08a04d32cb2468.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/predict/Img3_jpeg.rf.3a846528a9da542cae08a04d32cb2468.jpg}
    \end{subfigure}
    % ====== Ejemplo 5 ======
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/original/Sep25_270_png.rf.afa3b720cb52b7b4e34639773be3a4b7.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/painted/Sep25_270_png.rf.afa3b720cb52b7b4e34639773be3a4b7.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/results/salmones/predict/Sep25_270_png.rf.afa3b720cb52b7b4e34639773be3a4b7.jpg}
    \end{subfigure}
    \caption[Ejemplos de segmentación obtenidos en Salmons]{Ejemplos de segmentación obtenidos con el modelo YOLOv8l-seg entrenado en Salmons. De izquierda a derecha: imagen original, máscaras etiquetadas (\textit{Ground Truth}) en rojo y predicción del modelo en azul.}
