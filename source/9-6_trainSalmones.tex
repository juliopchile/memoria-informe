...
% TODO Corrección [12]: Corregir acento "idéntico".
...
% TODO Corrección [12]: Cambiar "imagenes" -> "imágenes" (dos veces).
...
% TODO Corrección [12]: Cambiar "imagenes" -> "imágenes" y "en como" -> "en cómo".
...
% TODO Corrección [12]: Sustituir "tomado con pinzas" por "interpretado con cautela".
...
\begin{center}
    ...
    \end{subfigure}
    \caption[Ejemplos de segmentación obtenidos en Salmons]{Ejemplos de segmentación obtenidos con el modelo YOLOv8l-seg entrenado en Salmons. De izquierda a derecha: imagen original; máscaras etiquetadas (\textit{Ground Truth}) en rojo; predicción del modelo en azul.}
