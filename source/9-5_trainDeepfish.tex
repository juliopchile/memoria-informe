...
\begin{center}
    ...
    \end{subfigure}
    \caption[Ejemplos de segmentación obtenidos en Deepfish]{Ejemplos de segmentación obtenidos con el modelo YOLOv8l-seg entrenado en Deepfish. De izquierda a derecha: imagen original, máscaras etiquetadas (\textit{Ground Truth}) en rojo y predicción del modelo en azul.}
