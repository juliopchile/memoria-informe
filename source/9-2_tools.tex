...
\label{sec:datasets}
% TODO Corrección [10] [TODO]: Cambiar redacción para usar consistentemente “dataset” en vez de “base de datos” cuando se refiere a conjuntos anotados de entrenamiento/validación. Ajustar masculino/femenino en frases como la citada en Correcciones.md ("El primero de carácter público...") reformulando: "El primer dataset es de carácter público... El segundo dataset es privado y se depura en una versión más refinada...".
